module Sandwich.Implementation.Openssl3.Tunnel.Bio_method
...
val impl__Bio__synchronize_states
      (self: t_Bio)
      (tun: Sandwich.Implementation.Openssl3.Tunnel.Ssl.t_Tunnel)
    : Prims.Pure Sandwich.Implementation.Openssl3.Tunnel.Ssl.t_Tunnel
      Prims.l_True
      (fun _ -> Prims.l_True)
...
fn bio_ctrl(bio: raw_pointer!(), cmd: int, larg: int, _pargs: raw_pointer!()) -> int {
    {
        (match (cast(cmd)) {
            ...
            11 => {
                ...
                >(
                    &(sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__flush(
                        &(sandwich::implementation::openssl3::tunnel::bio_method::Bio(
...
fn bio_read(
    ...
    {
        let bio: sandwich::implementation::openssl3::tunnel::bio_method::t_Bio = {
            sandwich::implementation::openssl3::tunnel::bio_method::Bio(
        ...
        {
            let _: tuple0 = {
                sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__clear_retry_flag(
                    &(bio),
                )
            };
            {
                (match (sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__read(
                    &(bio),
                    &mut (deref(
                    ...
                    core::result::Result_Err(e) => {
                        sandwich::implementation::openssl3::tunnel::bio_method::bio_reflect_io_error::<
                            arrow!(tuple0 -> int),
                            arrow!(tuple0 -> int),
                            int,
                        >(
                            ...
                            (|_| {
                                {
                                    let _: tuple0 = {
                                        sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__set_retry_read_flag(
                                            &(bio),
                                        )
                                    };
                                    { 1 }
                            ...
                            (|_| {
                                {
                                    let _: tuple0 = {
                                        sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__declare_closed(
                                            &(bio),
                                        )
                                    };
                                    { 1 }
...
fn bio_write(
...
) -> int {
    {
        ...
        };
        {
            ...
            {
                (match (sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__write(
                    &(bio),
                    &(deref(
                    ...
                    core::result::Result_Err(e) => {
                        ...
                        >(
                            ...
                            (|_| {
                                {
                                    let _: tuple0 = {
                                        sandwich::implementation::openssl3::tunnel::bio_method::impl__Bio__set_retry_write_flag(
                                            &(bio),
                                        )
                                    };
                                    { 1 }
...
let v_BIO_METH_OBJECT: Openssl3.t_bio_method_st =
  {
    ...
    =
    Rust_primitives.Hax.failure "(reject_RawOrMutPointer) ExplicitRejection { reason: \"a node of kind [Raw_pointer] have been found in the AST\" }"
      "core::option::Option_Some(\n        sandwich::implementation::openssl3::tunnel::bio_method::bio_write,\n    )"
    ;
    ...
    =
    Rust_primitives.Hax.failure "(reject_RawOrMutPointer) ExplicitRejection { reason: \"a node of kind [Raw_pointer] have been found in the AST\" }"
      "core::option::Option_Some(\n        sandwich::implementation::openssl3::tunnel::bio_method::bio_read,\n    )"
    ;
    ...
    =
    Rust_primitives.Hax.failure "(reject_RawOrMutPointer) ExplicitRejection { reason: \"a node of kind [Raw_pointer] have been found in the AST\" }"
      "core::option::Option_Some(\n        sandwich::implementation::openssl3::tunnel::bio_method::bio_ctrl,\n    )"
    ;
    Openssl3.f_create
    =
    Rust_primitives.Hax.failure "(reject_RawOrMutPointer) ExplicitRejection { reason: \"a node of kind [Raw_pointer] have been found in the AST\" }"
      "core::option::Option_Some(\n        sandwich::implementation::openssl3::tunnel::bio_method::bio_create,\n    )"
    ;
    Openssl3.f_destroy
    =
    Rust_primitives.Hax.failure "(reject_RawOrMutPointer) ExplicitRejection { reason: \"a node of kind [Raw_pointer] have been found in the AST\" }"
      "core::option::Option_Some(\n        sandwich::implementation::openssl3::tunnel::bio_method::bio_destroy,\n    )"
    ;
