...
let impl: Core.Default.t_Default t_ProviderBuilder =
  {
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_8: Core.Convert.t_TryFrom t_ErrorLibrary i32 =
  {
    f_Error = Prims.unit;
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_15: Core.Convert.t_TryFrom t_SslError i32 =
  {
    f_Error = Prims.unit;
    f_try_from_pre = (fun (err: i32) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_3: Core.Fmt.t_Debug t_Error =
  {
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_4: Core.Convert.t_From t_Error u64 =
  {
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_6: Core.Convert.t_From Sandwich_proto.Tunnel.t_RecordError t_SslError =
  {
